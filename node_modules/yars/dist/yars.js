...
var Store = function () {
  ...
  _createClass(Store, [{
    key: 'subscribe',
    value: function subscribe(component, watchedData) {
    ...
    value: function renderSubscribers(newData) {
      return Promise.all(this.subscribers.map(function (subscriber) {
        return subscriber.renderComponent(newData);
...
var Subscriber = function () {
   ...
   * @see https://lodash.com/docs/4.17.4#has
   */
  function Subscriber(component, watchedData) {
  ...
  _createClass(Subscriber, [{
    ...
    value: function shouldComponentUpdate(newData) {
      var shouldRender = false;
      var watchedDataLenght = this.watchedData ? this.watchedData.length : 0;

      if (watchedDataLenght > 0) {
        for (var i = 0; i < watchedDataLenght; i++) {
    ...
    key: 'renderComponent',
    value: function renderComponent(newData) {
      var _this = this;

      return new Promise(function (resolve) {
        if (_this.shouldComponentUpdate(newData) === true) {
          var index = _this.component.state && _this.component.state.__shouldRender ? _this.component.state.__shouldRender : 0;

          _this.component.setState({ __shouldRender: index + 1 });
        }
